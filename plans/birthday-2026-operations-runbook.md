...
2. Run `/urodziny-admin przydziel-zapisy` for the initial balanced roster, then
   `/urodziny-admin synchronizuj-role` until every role succeeds. Registration
   remains open; later participants receive a team immediately when they join.
