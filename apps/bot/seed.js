...
var getGuildSetting_1 = require("./src/util/getGuildSetting");
...
var createDefaultItems = function (guildId) { return __awaiter(void 0, void 0, void 0, function () {
    var existingItems, existingItemTypes, itemTypesToCreate, _i, itemTypesToCreate_1, item;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, db_1.prisma.item.findMany({
                    where: { type: { in: specializedConstants_1.DEFAULT_ITEMS.map(function (it) { return it.type; }) } },
                })];
            case 1:
                existingItems = _a.sent();
                existingItemTypes = existingItems.map(function (item) { return item.type; });
                console.log("Default item types already exist: ".concat(existingItemTypes.join(", ")));
                itemTypesToCreate = specializedConstants_1.DEFAULT_ITEMS.filter(function (_a) {
                    var type = _a.type;
                    return !existingItemTypes.includes(type);
                });
                _i = 0, itemTypesToCreate_1 = itemTypesToCreate;
                _a.label = 2;
            case 2:
                if (!(_i < itemTypesToCreate_1.length)) return [3 /*break*/, 5];
                item = itemTypesToCreate_1[_i];
                return [4 /*yield*/, db_1.prisma.item.create({
                        data: __assign(__assign({}, item), { guildId: guildId, createdBy: specializedConstants_1.USER_IDS.Defous }),
                    })];
            case 3:
                _a.sent();
                console.log("Created default item of type ".concat(item.type, " '").concat(item.name, "'"));
                _a.label = 4;
            case 4:
                _i++;
                return [3 /*break*/, 2];
...
var setDefaultLogChannels = function (guildId) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                defaultLogChannels = (0, getGuildSetting_1.getGuildSetting)(specializedConstants_1.DEFAULT_LOG_CHANNELS, guildId);
