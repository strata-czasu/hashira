...
export const MONSTER_TEMPLATES = {
  ...
  zombieCat: {
    ...
    actions: [
      ...
      },
      {
        ...
        isAoe: false,
        canTargetSelf: true,
        effects: { strength: 8, shield: -2 } satisfies ActionEffect,
      },
      {
  ...
  harpy: {
    ...
    actions: [
      ...
      {
        name: "Spoiler",
        description: "Ogłusza wszystkich przeciwników, zdradzając zakończenie filmu.",
        actionType: "attack" as const,
        power: 12,
        weight: 90,
        cooldown: 5,
  ...
  possessedDoll: {
    ...
    actions: [
      ...
      },
      {
        ...
        isAoe: false,
        canTargetSelf: true,
        effects: { strength: 6 } satisfies ActionEffect,
      },
    ],
  },
  succubus: {
    ...
    actions: [
      {
        ...
        isAoe: false,
        canTargetSelf: false,
        effects: { weakness: 4, shield: -4 } satisfies ActionEffect,
      },
      {
  ...
  cerber: {
    ...
    actions: [
      ...
      },
      {
        ...
        isAoe: false,
        canTargetSelf: true,
        effects: { regen: 2, shield: 6 } satisfies ActionEffect,
      },
      {
        name: "Kły Cerbera",
        description:
      ...
      },
      {
        ...
        description: "Przerażający ryk, który ogłusza wszystkich wrogów.",
        actionType: "debuff" as const,
        power: 8,
        weight: 70,
        cooldown: 10,
  ...
  headlessHorseman: {
    ...
    actions: [
      ...
      },
      {
        ...
        isAoe: false,
        canTargetSelf: false,
        effects: { stun: true, weakness: 2 } satisfies ActionEffect,
      },
      {
        name: "Eksplozja Dyni",
        description:
        ...
        isAoe: true,
        canTargetSelf: false,
        effects: { burn: 4 } satisfies ActionEffect,
      },
      {
...
export const PLAYER_ABILITIES = [
  ...
  },
  {
    ...
    isAoe: false,
    isDefault: true,
    effects: { berserk: true, strength: 3 },
  },
] as const;
