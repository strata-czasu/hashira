...
var giveaway_1 = require("./giveaway/giveaway");
...
var moderatorLeave_1 = require("./moderatorLeave");
var pearto_1 = require("./pearto");
...
exports.bot = new core_1.Hashira({ name: "bot" })
    ...
    .use(massDM_1.massDM)
    .use(fish_1.fish)
    .use(giveaway_1.giveaway)
    .use(pearto_1.pearto)
    .use(ranking_1.ranking)
    .use(moderatorLeave_1.moderatorLeave)
