            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        if (!itx.inCachedGuild())
                            return [2 /*return*/];
                        return [4 /*yield*/, prisma.shopItem.findMany({
                                where: {
                                    deletedAt: null,
                                    item: {
                                        guildId: itx.guildId,
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, prisma.$transaction(function (tx) { return __awaiter(void 0, void 0, void 0, function () {
                                ...
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0: return [4 /*yield*/, (0, util_1.getShopItem)(tx, id, itx.guildId)];
                                        case 1:
                                            shopItem = _a.sent();
        ...
        return command
            ...
            return __generator(this, function (_e) {
                switch (_e.label) {
                    ...
                    case 1:
                        _e.sent();
                        return [4 /*yield*/, (0, util_1.getItem)(prisma, id, itx.guildId)];
                    case 2:
                        item = _e.sent();
        ...
        return command
            ...
            return __generator(this, function (_e) {
                switch (_e.label) {
                    ...
                    case 1:
                        _e.sent();
                        return [4 /*yield*/, (0, util_1.getShopItem)(prisma, id, itx.guildId)];
                    case 2:
                        shopItem = _e.sent();
