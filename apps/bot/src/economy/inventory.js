            ...
            return __generator(this, function (_e) {
                switch (_e.label) {
                    ...
                    case 7:
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0: return [4 /*yield*/, prisma.$transaction(function (tx) { return __awaiter(void 0, void 0, void 0, function () {
                                            ...
                                            return __generator(this, function (_a) {
                                                switch (_a.label) {
                                                    case 0: return [4 /*yield*/, (0, util_1.getInventoryItem)(tx, itemId, itx.user.id)];
                                                    case 1:
                        ...
                        return [4 /*yield*/, lock.run(["inventory_item_transfer_".concat(itx.user.id, "_").concat(itemId)], function () { return __awaiter(void 0, void 0, void 0, function () { return __generator(this, function (_a) {
                ...
                switch (_e.label) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, prisma.$transaction(function (tx) { return __awaiter(void 0, void 0, void 0, function () {
                                ...
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0: return [4 /*yield*/, (0, util_1.getItem)(tx, itemId)];
                                        case 1:
                                            item = _a.sent();
                    ...
                    case 3:
                        ...
                        return [4 /*yield*/, itx.editReply("Dodano ".concat((0, discord_js_1.bold)(item.name), " do ekwipunku ").concat((0, discord_js_1.bold)(user.tag)))];
                    case 4:
                        _e.sent();
                        return [2 /*return*/];
                }
                ...
                switch (_e.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, prisma.$transaction(function (tx) { return __awaiter(void 0, void 0, void 0, function () {
                                ...
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0: return [4 /*yield*/, (0, util_1.getItem)(prisma, itemId)];
                                        case 1:
                                            item = _a.sent();
                                            if (!!item) return [3 /*break*/, 3];
                                            return [4 /*yield*/, (0, errorFollowUp_1.errorFollowUp)(itx, "Przedmiot o podanym ID nie istnieje")];
                                        case 2: return [2 /*return*/, _a.sent()];
                                        case 3: return [4 /*yield*/, (0, util_1.getInventoryItem)(tx, itemId, user.id)];
                                        case 4:
                                            inventoryItem = _a.sent();
