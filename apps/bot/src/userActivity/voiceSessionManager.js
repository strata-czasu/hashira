...
var MAX_SESSION_DURATION = { minutes: 15 };
var MAX_SESSION_DURATION_SECONDS = (0, duration_1.durationToSeconds)(MAX_SESSION_DURATION);
var VoiceSessionManager = /** @class */ (function () {
    ...
    VoiceSessionManager.prototype.startVoiceSession = function (channelId, state, now) {
        return __awaiter(this, void 0, void 0, function () {
            var key, voiceSession;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (!newState.channel)
                            return [2 /*return*/];
                        return [4 /*yield*/, this.startVoiceSession(newState.channel.id, newState, now)];
                    case 2: return [2 /*return*/, _a.sent()];
                    case 3:
                        delta = (0, date_fns_1.differenceInSeconds)(now, session.lastUpdate);
                        this.updateSessionTimes(session, delta);
                        if (!(delta > MAX_SESSION_DURATION_SECONDS)) return [3 /*break*/, 6];
                        return [4 /*yield*/, this.endVoiceSession(newState, now)];
                    case 4:
                        _a.sent();
                        return [4 /*yield*/, this.startVoiceSession(session.channelId, newState, now)];
                    case 5:
                        _a.sent();
                        return [2 /*return*/];
                    case 6:
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        now = new Date();
                        if (!!session) return [3 /*break*/, 3];
                        return [4 /*yield*/, this.startVoiceSession(voiceState.channel.id, voiceState, now)];
                    case 2:
                        _a.sent();
                        return [2 /*return*/, [key]];
                    case 3:
