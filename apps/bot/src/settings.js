...
var formatUserSetting = function (name, userId) {
    return "".concat(name, ": ").concat(userId ? "".concat((0, discord_js_1.userMention)(userId)) : "Nie ustawiono");
};
...
exports.settings = new core_1.Hashira({ name: "settings" })
    ...
    return group
        ...
        .addCommand("urlop-role", function (command) {
        return command
            .setDescription("Ustaw rolę Urlop")
            .addRole("role", function (role) {
            return role.setDescription("Rola, która ma być nadawana moderatorom na urlopie");
        })
            .handle(function (_a, _b, itx_1) { return __awaiter(void 0, [_a, _b, itx_1], void 0, function (_c, _d, itx) {
            var prisma = _c.prisma;
            var role = _d.role;
            return __generator(this, function (_e) {
                switch (_e.label) {
                    ...
                    case 1:
                        _e.sent();
                        return [4 /*yield*/, itx.reply({
                                content: "Rola Urlop zosta\u0142a ustawiona na ".concat((0, discord_js_1.roleMention)(role.id)),
                                flags: "Ephemeral",
                            })];
                    case 2:
                        _e.sent();
        ...
        .addCommand("urlop-manager", function (command) {
        return command
            .setDescription("Ustaw managera urlopów")
            .addUser("user", function (user) {
            return user.setDescription("Użytkownik, który ma być managerem urlopów");
        })
            .handle(function (_a, _b, itx_1) { return __awaiter(void 0, [_a, _b, itx_1], void 0, function (_c, _d, itx) {
            var prisma = _c.prisma;
            var user = _d.user;
            return __generator(this, function (_e) {
                switch (_e.label) {
                    ...
                    case 1:
                        _e.sent();
                        return [4 /*yield*/, itx.reply({
                                content: "Manager urlop\u00F3w zosta\u0142 ustawiony na ".concat((0, discord_js_1.userMention)(user.id)),
                                flags: "Ephemeral",
                            })];
                    case 2:
                        _e.sent();
