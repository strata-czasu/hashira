 ...
 */
function fetchMembers(guild, users) {
    return __awaiter(this, void 0, void 0, function () {
        var uniqueUsers, members, resolvedMembers;
        var _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    uniqueUsers = (0, es_toolkit_1.uniq)(users);
                    members = (0, es_toolkit_1.chunk)(uniqueUsers, 100).map(function (chunk) {
                        return guild.members.fetch({ user: chunk });
                    });
                    return [4 /*yield*/, Promise.all(members)];
                case 1:
                    resolvedMembers = _b.sent();
                    return [2 /*return*/, (_a = new discord_js_1.Collection()).concat.apply(_a, resolvedMembers)];
            }
        });
    });
}
