...
exports.userTransfer = new core_1.Hashira({ name: "user-transfer" })
    ...
    return command
        ...
        var confirmation, responses, lines, okResponses, errorResponses, noopResponses;
        ...
        return __generator(this, function (_e) {
            switch (_e.label) {
                ...
                case 1:
                    _e.sent();
                    return [4 /*yield*/, (0, core_1.waitForConfirmation)({ send: itx.editReply.bind(itx) }, "Czy na pewno chcesz przenie\u015B\u0107 dane?\nZ ".concat((0, discord_js_1.bold)(oldUser.tag), " (").concat((0, discord_js_1.inlineCode)(newUser.id), ")\nDO ").concat((0, discord_js_1.bold)(newUser.tag), " (").concat((0, discord_js_1.inlineCode)(newUser.id), ")"), "Tak", "Nie", function (action) { return action.user.id === itx.user.id; })];
                case 2:
