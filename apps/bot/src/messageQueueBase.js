...
exports.messageQueueBase = new core_1.Hashira({ name: "messageQueueBase" })
    ...
    return __assign(__assign({}, ctx), { messageQueue: new tasks_1.MessageQueue(ctx.prisma)
            ...
            var currentUltimatum, updatedUltimatum, guild, member;
                ...
                switch (_e.label) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, (0, discordTry_1.discordTry)(function () { return __awaiter(void 0, void 0, void 0, function () { return __generator(this, function (_a) {
                                return [2 /*return*/, client.guilds.fetch(guildId)];
            ...
            var verificationInProgress, settings, muteRoleId, guild, member;
            var client = _c.client;
            ...
            return __generator(this, function (_e) {
                switch (_e.label) {
                    ...
                    case 6:
                        ...
                        return [4 /*yield*/, (0, discordTry_1.discordTry)(function () { return __awaiter(void 0, void 0, void 0, function () {
                                ...
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0:
                                            reason = (0, util_1.formatBanReason)("Nieudana weryfikacja 16+ [".concat(verificationId, "]"), moderator, rejectedAt);
                    ...
                    case 7:
                        banned = _e.sent();
                        directMessageContent = "Weryfikacja 16+ ".concat((0, util_1.formatUserWithId)(user), " [").concat((0, discord_js_1.inlineCode)(verificationId.toString()), "] dobieg\u0142a ko\u0144ca.");
                        if (banned) {
            ...
            return __generator(this, function (_e) {
                switch (_e.label) {
                    ...
                    case 3:
                        ...
                        if (!moderator || !user)
                            return [2 /*return*/];
                        return [4 /*yield*/, (0, sendDirectMessage_1.sendDirectMessage)(moderator, "Weryfikacja 16+ ".concat((0, util_1.formatUserWithId)(user), " [").concat((0, discord_js_1.inlineCode)(verificationId.toString()), "] trwa ju\u017C ").concat((0, date_fns_1.formatDuration)(elapsed), ". Pozosta\u0142o ").concat((0, date_fns_1.formatDuration)(remaining), ". Nie zapomnij o niej!"))];
                    case 4:
                        _e.sent();
                        return [2 /*return*/];
                }
