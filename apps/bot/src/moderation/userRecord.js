...
exports.userRecord = new core_1.Hashira({ name: "user-record" })
    ...
    return command
        ...
        var dbUser, member, embed, verificationStatusParts, verification, mutes, joinedMutes, warns, joinedWarns, textActivity, voiceActivitySeconds, activityLines;
            ...
            switch (_e.label) {
                ...
                case 6:
                    ...
                    if (mutes.length > 0) {
                        joinedMutes = mutes
                            .map(function (m) {
                            return "".concat((0, discord_js_1.time)(m.createdAt, discord_js_1.TimestampStyles.ShortDateTime), "+").concat((0, util_1.formatMuteLength)(m), " ").concat((0, discord_js_1.italic)(m.reason));
                        })
                            .join("\n");
                        embed.addFields({
                ...
                case 9:
                    voiceActivitySeconds = (_e.sent())._sum.secondsSpent;
                    activityLines = [
                        "\uD83C\uDF99\uFE0F ".concat((0, date_fns_1.secondsToHours)(voiceActivitySeconds !== null && voiceActivitySeconds !== void 0 ? voiceActivitySeconds : 0), "h"),
