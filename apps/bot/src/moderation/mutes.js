    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 3:
                ...
                daysSinceEnd = (_a = (0, date_fns_1.intervalToDuration)({ start: latestUltimatum.endedAt, end: new Date() }).days) !== null && _a !== void 0 ? _a : 0;
...
var universalAddMute = function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
    var member, guildId, now, activeMute, muteRoleId, parsedDuration, endsAt, mute, appliedMute, sentMessage;
    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            ...
            case 3:
                _c.sent();
                return [2 /*return*/];
            case 4: return [4 /*yield*/, (0, util_1.getMuteRoleId)(prisma, guildId)];
            case 5:
                muteRoleId = _c.sent();
                if (!!muteRoleId) return [3 /*break*/, 7];
            ...
            case 12:
                mute = _c.sent();
                return [4 /*yield*/, (0, util_1.applyMute)(member, muteRoleId, "Wyciszenie: ".concat(reason, " [").concat(mute.id, "]"))];
            case 13:
                appliedMute = _c.sent();
    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            ...
            case 2:
                ...
                if (!muteRoleId)
                    return [2 /*return*/];
                return [4 /*yield*/, (0, util_1.applyMute)(member, muteRoleId, "Przywr\u00F3cone wyciszenie [".concat(activeMute.id, "]"))];
            case 3:
                _c.sent();
                return [2 /*return*/];
        }
