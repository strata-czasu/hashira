...
var get18PlusRoleId = function (prisma, guildId) { return __awaiter(void 0, void 0, void 0, function () {
    var settings;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [2 /*return*/, settings.plus18RoleId];
        }
    });
}); };
...
exports.verification = new core_1.Hashira({ name: "verification" })
    ...
    return group
        ...
        return command
            ...
            var member, dbUser, verificationInProgress, muteRoleId, appliedMute, verification, sentMessage;
            ...
            return __generator(this, function (_e) {
                switch (_e.label) {
                    ...
                    case 9: return [4 /*yield*/, (0, util_1.getMuteRoleId)(prisma, itx.guildId)];
                    case 10:
                        muteRoleId = _e.sent();
                        if (!!muteRoleId) return [3 /*break*/, 12];
                        return [4 /*yield*/, (0, errorFollowUp_1.errorFollowUp)(itx, "Rola do wyciszeń nie jest ustawiona. Użyj komendy `/settings mute-role`")];
                    case 11:
                        _e.sent();
                        return [2 /*return*/];
                    case 12: return [4 /*yield*/, (0, util_1.applyMute)(member, muteRoleId, "Weryfikacja 16+, moderator: ".concat(itx.user.tag, " (").concat(itx.user.id, ")"))];
                    case 13:
                        appliedMute = _e.sent();
        ...
        return command
            ...
            .handle(function (_a, _b, itx_1) { return __awaiter(void 0, [_a, _b, itx_1], void 0, function (_c, _d, itx) {
            var verificationType, dbUser, currentVerificationLevel, active16PlusVerification, activeMute, shouldRemoveMute, muteRemovalFailed, plus18RoleAdditionFailed, plus18RoleId_1, directMessageContent, sentMessage;
            var prisma = _c.prisma, messageQueue = _c.messageQueue;
            ...
            return __generator(this, function (_e) {
                switch (_e.label) {
                    ...
                    case 3:
                        ...
                        if (!dbUser)
                            return [2 /*return*/];
                        if (!satisfiesVerificationLevel(dbUser.verificationLevel, verificationType)) return [3 /*break*/, 5];
                        return [4 /*yield*/, (0, errorFollowUp_1.errorFollowUp)(itx, "".concat((0, discord_js_1.userMention)(user.id), " ma ju\u017C weryfikacj\u0119 ").concat((0, exports.formatVerificationType)(verificationType)))];
                    ...
                    case 5:
                        ...
                        return [4 /*yield*/, prisma.$transaction(function (tx) { return __awaiter(void 0, void 0, void 0, function () {
                                ...
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0: return [4 /*yield*/, getActive16PlusVerification(tx, itx.guildId, user.id)];
                                        case 1:
                                        ...
                                        case 4:
                                            ...
                                            return [3 /*break*/, 7];
                                        case 5:
                                            if (!(currentVerificationLevel === null)) return [3 /*break*/, 7];
                                            // Create a 16_plus verification if there is no active verification.
                                            return [4 /*yield*/, tx.verification.create({
                                                    data: {
                                        ...
                                        case 6:
                                            ...
                                            _a.label = 7;
                                        case 7:
                                            if (!(verificationType === "plus18")) return [3 /*break*/, 9];
                                            return [4 /*yield*/, tx.verification.create({
                                                    data: {
                                                        createdAt: itx.createdAt,
                                                        acceptedAt: itx.createdAt,
                                        ...
                                        case 8:
                                            _a.sent();
                                            _a.label = 9;
                                        case 9: return [4 /*yield*/, tx.user.update({
                                                where: { id: user.id },
                                                data: { verificationLevel: verificationType },
                                            })];
                                        case 10:
                                            _a.sent();
                                            return [2 /*return*/, active16PlusVerification];
                                    }
                                });
                            }); })];
                    case 6:
                        active16PlusVerification = _e.sent();
                    ...
                    case 7:
                        activeMute = _e.sent();
                        shouldRemoveMute = active16PlusVerification && !activeMute;
                        muteRemovalFailed = false;
                        if (!shouldRemoveMute) return [3 /*break*/, 9];
                        return [4 /*yield*/, (0, discordTry_1.discordTry)(function () { return __awaiter(void 0, void 0, void 0, function () {
                                var muteRoleId, member;
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0: return [4 /*yield*/, (0, util_1.getMuteRoleId)(prisma, itx.guildId)];
                                        case 1:
                                            muteRoleId = _a.sent();
                                            if (!muteRoleId)
                                        ...
                                        case 2:
                                            member = _a.sent();
                                            return [4 /*yield*/, member.roles.remove(muteRoleId, "Weryfikacja 16+ przyj\u0119ta przez ".concat(itx.user.tag, " (").concat(itx.user.id, ")"))];
                                        case 3:
                                            _a.sent();
                                ...
                                discord_js_1.RESTJSONErrorCodes.UnknownMember,
                                discord_js_1.RESTJSONErrorCodes.MissingPermissions,
                            ], function () { return true; })];
                    case 8:
                        muteRemovalFailed = _e.sent();
                        _e.label = 9;
                    case 9:
                        plus18RoleAdditionFailed = false;
                        if (!(verificationType === "plus18")) return [3 /*break*/, 12];
                        return [4 /*yield*/, get18PlusRoleId(prisma, itx.guildId)];
                    case 10:
                        plus18RoleId_1 = _e.sent();
                        if (!plus18RoleId_1) return [3 /*break*/, 12];
                        return [4 /*yield*/, (0, discordTry_1.discordTry)(function () { return __awaiter(void 0, void 0, void 0, function () {
                                var member;
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0: return [4 /*yield*/, itx.guild.members.fetch(user.id)];
                                        case 1:
                                            member = _a.sent();
                                            return [4 /*yield*/, member.roles.add(plus18RoleId_1, "Weryfikacja 18+ przyj\u0119ta przez ".concat(itx.user.tag, " (").concat(itx.user.id, ")"))];
                                        case 2:
                                            _a.sent();
                                            return [2 /*return*/, false];
                                    }
                    ...
                    case 11:
                        plus18RoleAdditionFailed = _e.sent();
                        _e.label = 12;
                    case 12:
                        if (verificationType === "plus16" && shouldRemoveMute) {
                            // any -> 16_plus with an active verification
                            directMessageContent = "Hej ".concat((0, discord_js_1.userMention)(user.id), "! To znowu ja. Przed chwil\u0105 **Twoja weryfikacja wieku zosta\u0142a pozytywnie rozpatrzona**. Tw\u00F3j mute zosta\u0142 usuni\u0119ty i od teraz b\u0119dziemy jako administracja wiedzie\u0107, \u017Ce masz uko\u0144czone 16 lat i nie b\u0119dziemy Ci\u0119 w przysz\u0142o\u015Bci weryfikowa\u0107 ponownie. \u017Bycz\u0119 Ci mi\u0142ego dnia i jeszcze raz pozdrawiam!");
                        }
                        else if (verificationType === "plus16" && !shouldRemoveMute) {
                            // any -> 16_plus with an active verification
                            directMessageContent = "Hej ".concat((0, discord_js_1.userMention)(user.id), "! To znowu ja. Przed chwil\u0105 **Twoja weryfikacja wieku zosta\u0142a pozytywnie rozpatrzona**. Od teraz b\u0119dziemy jako administracja wiedzie\u0107, \u017Ce masz uko\u0144czone 16 lat i nie b\u0119dziemy Ci\u0119 w przysz\u0142o\u015Bci weryfikowa\u0107 ponownie. \u017Bycz\u0119 Ci mi\u0142ego dnia i jeszcze raz pozdrawiam!");
                        }
                            ...
                            throw new Error("Invalid verification transition from ".concat(currentVerificationLevel, " to ").concat(verificationType));
                        }
                        return [4 /*yield*/, (0, sendDirectMessage_1.sendDirectMessage)(user, directMessageContent)];
                    case 13:
                        sentMessage = _e.sent();
                        return [4 /*yield*/, itx.editReply("Przyj\u0119to weryfikacj\u0119 ".concat((0, exports.formatVerificationType)(verificationType), " dla ").concat((0, discord_js_1.userMention)(user.id)))];
                    case 14:
                        _e.sent();
                        if (!(shouldRemoveMute && muteRemovalFailed)) return [3 /*break*/, 16];
                        return [4 /*yield*/, (0, errorFollowUp_1.errorFollowUp)(itx, "Nie uda\u0142o si\u0119 usun\u0105\u0107 roli wyciszenia dla ".concat((0, util_1.formatUserWithId)(user), "."))];
                    case 15:
                        _e.sent();
                        _e.label = 16;
                    case 16:
                        if (!(verificationType === "plus18" && plus18RoleAdditionFailed)) return [3 /*break*/, 18];
                        return [4 /*yield*/, (0, errorFollowUp_1.errorFollowUp)(itx, "Nie uda\u0142o si\u0119 doda\u0107 roli 18+ dla ".concat((0, util_1.formatUserWithId)(user), "."))];
                    case 17:
                        _e.sent();
                        _e.label = 18;
                    case 18:
            ...
            return __generator(this, function (_e) {
                switch (_e.label) {
                    ...
                    case 3:
                        _e.sent();
                        return [4 /*yield*/, prisma.$transaction(function (tx) { return __awaiter(void 0, void 0, void 0, function () {
                                var verificationInProgress, muteRoleId;
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        ...
                                        case 3:
                                            _a.sent();
                                            return [4 /*yield*/, (0, util_1.getMuteRoleId)(prisma, itx.guildId)];
                                        case 4:
                                            muteRoleId = _a.sent();
                                            if (!muteRoleId)
                                                return [2 /*return*/, { status: "mute_role_not_set" }];
                                            return [2 /*return*/, { status: "success", muteRoleId: muteRoleId }];
                                    }
                                });
                            }); })];
                    case 4:
    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0: return [4 /*yield*/, getActive16PlusVerification(prisma, member.guild.id, member.id)];
            case 1:
                verificationInProgress = _c.sent();
                if (!verificationInProgress)
                    return [2 /*return*/];
                return [4 /*yield*/, (0, util_1.getMuteRoleId)(prisma, member.guild.id)];
            case 2:
                muteRoleId = _c.sent();
                if (!muteRoleId)
                    return [2 /*return*/];
