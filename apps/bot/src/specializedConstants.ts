...
export const DEFAULT_LOG_CHANNELS = {
  ...
  [GUILD_IDS.Homik]: {
    MESSAGE: "1318731068165193848",
    MEMBER: "1318731068165193848",
    ROLE: "1318731068165193848",
    MODERATION: "1318731068165193848",
    PROFILE: "1318731068165193848",
    ECONOMY: "1318731068165193848",
  },
} as const;
...
export const TICKET_REMINDER_SETTINGS = {
  [GUILD_IDS.StrataCzasu]: {
    ...
    PING_CHANNEL: "1345122860049502388",
    PING_ROLE: "1347346254430081054",
  },
  [GUILD_IDS.Piwnica]: {
    CATEGORY: "1344766355181670541",
    PING_CHANNEL: "1450190890369941674",
    PING_ROLE: "1450191419250577540",
  },
  [GUILD_IDS.Homik]: {
    CATEGORY: "1345124471870324736",
    PING_CHANNEL: "1231334409228255384",
    PING_ROLE: null,
  },
} as const;
